...
/**
 * The {@code Replacer} class represents a simple structure that does no more than 
...
public class Replacer {
     ...
     * big as needed, but neither can be null, and bookmark cannot be an empty string.
     * 
     * @param bookmark A bookmark
     * @param replacement A replacement
     * @throws IllegalArgumentException if either param is null, or if bookmark is blank
     */
